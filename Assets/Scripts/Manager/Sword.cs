...
namespace Manager {
  public class Sword : MonoBehaviour {
    ...
    public void Swing() {
      ...
      ToggleSword(true);
      // TODO: Have to determine which Sword FX should play... need to know if at full health
      Game.Audio.PlayFX(FX.SwordSlash);
    }

    public void ToggleSword(bool isActive = false) {
      gameObject.SetActive(isActive);
    }

    private void SetPosition(Vector3 movement) {
      if (movement.x > 0) {
